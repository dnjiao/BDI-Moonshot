...
public class FmReportPertNegTb implements Serializable {
	...
	@Column(name="FM_REPORT_ALT_ID")
	private BigDecimal fmReportAltId;
	...
	public BigDecimal getFmReportAltId() {
		return this.fmReportAltId;
	}

	public void setFmReportAltId(BigDecimal fmReportAltId) {
		this.fmReportAltId = fmReportAltId;
	}
